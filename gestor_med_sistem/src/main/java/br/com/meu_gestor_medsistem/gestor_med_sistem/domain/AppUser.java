...
public class AppUser {
    ...
    @NotNull @Enumerated(EnumType.STRING) private UserType type;
    @NotBlank @Size(max = 120) private String name;
    @Valid @NotNull @Embedded @AttributeOverride(name = "value", column = @Column(name = "email")) private Email email;
    @NotNull @Enumerated(EnumType.STRING) private UserStatus status;
}
